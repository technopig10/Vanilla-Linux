...
echo
	...
	#adklinuxVersion='v21.03.1'

	#isoLabel='adklinux-next-'$adklinuxVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 60-1"
	buildFolder=$HOME"/vanilla-build"
	outFolder=$HOME"/vanilla-Out"
	archisoVersion=$(sudo pacman -Q archiso)

	echo "################################################################## "
	#echo "Building the desktop                   : "$desktop
	#echo "Building version                       : "$vanillalinuxVersion
...
echo
	...
	echo
	mkdir $buildFolder
	cp -r ../vanilla-linux $buildFolder/vanilla-linux
...
#	echo "Getting the last version of bashrc in /etc/skel"
#	echo
#	wget https://raw.githubusercontent.com/adklinux/adklinux-root/master/etc/skel/.bashrc-latest -O $buildFolder/archiso/airootfs/etc/skel/.bashrc
...
#
# 	#profiledef.sh
# 	oldname1='iso_name=adklinux'
# 	newname1='iso_name=adklinux'
#
# 	oldname2='iso_label="adklinux'
# 	newname2='iso_label="adklinux'
#
# 	oldname3='adklinux'
# 	newname3='adklinux'
#
...
echo
	...
	cd $buildFolder/vanilla-linux/
	sudo mkarchiso -v -w $buildFolder -o $outFolder $buildFolder/vanilla-linux/
